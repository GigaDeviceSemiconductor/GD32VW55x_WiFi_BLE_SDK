                                                ...
                                                void * pvPublishInfo )
{
    ...
    else
    {
        ...
        if( pxContext->_internal.callbacks.xCloudToDeviceMessageCallback )
        {
            ...
            xCloudToDeviceMessage.pcTopicName = xMQTTPublishInfo->pcTopicName;
            xCloudToDeviceMessage.usTopicNameLength = xMQTTPublishInfo->usTopicNameLength;
#endif
                                                    ...
                                                    void * pvPublishInfo )
{
    ...
    else
    {
        ...
        {
#ifdef CONFIG_AZURE_F527_DEMO_SUPPORT
            xCommandRequest.pcTopicName = xMQTTPublishInfo->pcTopicName;
            xCommandRequest.usTopicNameLength = xMQTTPublishInfo->usTopicNameLength;
#endif
                                                       ...
                                                       void * pvPublishInfo )
{
    ...
    else
    {
        ...
        if( pxContext->_internal.callbacks.xPropertiesCallback )
        {
            ...
            {
#ifdef CONFIG_AZURE_F527_DEMO_SUPPORT
                xPropertiesResponse.pcTopicName = xMQTTPublishInfo->pcTopicName;
                xPropertiesResponse.usTopicNameLength = xMQTTPublishInfo->usTopicNameLength;
#endif

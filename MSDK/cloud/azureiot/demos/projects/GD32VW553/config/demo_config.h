...
/**
 * @brief Set the task priority of the main demo task.
 *
 */
#define democonfigDEMO_TASKPRIO             ( 2 )

#ifdef CONFIG_AZURE_F527_DEMO_SUPPORT
#define democonfigDEMO_QUEUESIZE            (10)
#define democonfigDEMO_ITEMSIZE             (sizeof(azure_at_message_t))
#define sampleaduPNP_COMPONENTS_LIST_LENGTH (8)
#endif
/**
...
/**
 * @brief Charge Sensor component name
 */
#define AZ_IOT_CHARGE_SENSOR_PROPERTIES_COMPONENT_NAME    "chargeSensor"


/**
 * @brief Set according to your OTA image.
 */
#define democonfigADU_DEVICE_MANUFACTURER    "GigaDevice"
#define democonfigADU_DEVICE_MODEL           "GD32VW553"
#define democonfigADU_UPDATE_PROVIDER        "GigaDevice"
#define democonfigADU_UPDATE_NAME            "GD32VW553"
/* new OTA image to be upgraded */
#define democonfigADU_UPDATE_VERSION         "1.0.2"

#define democonfigSNTP_INIT_WAIT             1672531200U /* January 1, 2023 */
#define democonfigSNTP_INIT_RETRY_DELAY      3000
#define democonfigSNTP_INIT_RETRY_COUNT      20

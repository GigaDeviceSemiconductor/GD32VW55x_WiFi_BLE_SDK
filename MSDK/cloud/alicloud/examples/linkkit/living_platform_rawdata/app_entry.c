...
static void load_living_platform_rawdata_meta_info(void)
{
    int len = 0;
...
{
    living_platform_rawdata_main_params_t paras;
    paras.argc = argc;
    paras.argv = argv;
...
#endif
    load_living_platform_rawdata_meta_info();

    living_platform_rawdata_main((void *)&paras);
